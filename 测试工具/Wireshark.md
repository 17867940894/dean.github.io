...
![在这里插入图片描述](./assets/2699669-20220525130836600-2121432594.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836561-648879419.png)

## 停止抓包

点击左上角的「红色按钮」，可以停止抓包
![在这里插入图片描述](./assets/2699669-20220525130836553-619623291.png)

## 保存数据

点击右上角的「文件」，选择「保存」，可以保存抓包的数据

![在这里插入图片描述](./assets/2699669-20220525130836521-683524664.png)
也可以直接点击工具栏的保存按钮

![在这里插入图片描述](./assets/2699669-20220525130836562-1432195780.png)

## 界面介绍

![在这里插入图片描述](./assets/2699669-20220525130836567-1270554672.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836547-1457640732.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836567-1793278095.png)
选中字段，按 Ctrl + Shift + I ，也可以实现同样的效果。

添加为列的字段会在数据列表中显示。
![在这里插入图片描述](./assets/2699669-20220525130836549-1425142625.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836552-2103341710.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836599-71934155.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836568-1878601084.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836592-384252658.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836553-1338696089.png)
在「导出分组界面」，选择第二个 「Selected packets only」，只保存选中的数据包。

![在这里插入图片描述](./assets/2699669-20220525130836571-1140710767.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836597-652587799.png)
在「导出分组界面」，勾选第三个 「Marked packets only」，只导出标记的数据包。

![在这里插入图片描述](./assets/2699669-20220525130836643-1055721084.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836603-1767475960.png)
勾选 在所有接口上使用混杂模式。

![在这里插入图片描述](./assets/2699669-20220525130836630-689716569.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836619-959924674.png)
在弹出的捕获选项界面，最下方的输入框中输入过滤语句，点击开始即可抓包。

![在这里插入图片描述](./assets/2699669-20220525130836600-590541398.png)
...
![在这里插入图片描述](./assets/2699669-20220525130836611-2139884777.png)
